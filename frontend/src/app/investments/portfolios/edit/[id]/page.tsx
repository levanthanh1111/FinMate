...
export default function EditInvestmentPortfolioPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight mb-2">Edit Portfolio</h1>
      <p className="text-slate-500 mb-6">Update portfolio details</p>
